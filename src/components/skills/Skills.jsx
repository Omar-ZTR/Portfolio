...
const Skills = () => {
  ...
  }, [startVal1, endVal1, startVal2, endVal2, startVal3, endVal3, startVal4, endVal4]);
  ...
  return (<div className='zind '>
    ...
    <section className="skills section " id="skills">
      ...
      <h3>My Advantages</h3> 
<p>I design products that are more than pretty. I make them shippable and usable, ttempor non mollit dolor et do aute</p>
      <div >
        <div className='face__Skills'>
          ...
          <div className='top__skills'>
            ...
            <div className='skills__levels' style={backgroundStyle1}>
              <span className='skill__value' data-values={22}  >{`${startVal1}%`}</span>
            </div>
            <span className='skill__name'>11 </span>
          </div>

          <div className='top__skills'>
            <img src={html} alt="hhh" />
            <div className='skills__levels' style={backgroundStyle2}>
              <span className='skill__value' data-values={22}>{`${startVal2}%`}</span>
            </div>
            <span className='skill__name'>22 </span>
          </div>
          ...
          <div className='top__skills'>
            ...
            <div className='skills__levels' style={backgroundStyle3}>
              <span className='skill__value' data-values={22}>{`${startVal3}%`}</span>
            </div>
            <span className='skill__name'>33 </span>
          </div>
