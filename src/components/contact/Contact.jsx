    ...
    >
      ...
      <div className="contact__container container grid">
        <div className="contact__info ">
          <div className="item__cont__info " data-aos="fade-right">
            <div className="item_cont_icon">
        ...
        {/* <div className="contact__content">
                    ...
                    <div className="contact__info">
                        {/* <div className="contact__card">
                            ...
                            <span className="contact__card-data">omarzouiter97@gmail.com</span>
                       ...
                       <div className="contact__card">
                            ...
                            <span className="contact__card-data">omar zouiter</span>
